enum ChequeAttachmentKind { statement }

class ChequeAttachment {
  const ChequeAttachment({
    this.id,
    this.serverUuid,
  ...
  /// Local SQLite id of the parent Cheque.
  final int chequeId;
  ...
  ChequeAttachment copyWith({
    Object? id = _unset,
    Object? serverUuid = _unset,
    int? chequeId,
    ChequeAttachmentKind? kind,
    String? fileName,
    String? mimeType,
