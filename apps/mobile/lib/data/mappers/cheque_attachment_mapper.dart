...
class ChequeAttachmentMapper {
  const ChequeAttachmentMapper._();

  static ChequeAttachment fromMap(Map<String, Object?> map) {
    return ChequeAttachment(
      id: _optionalInt(map['id']),
      serverUuid: _optionalString(map['server_uuid']),
      chequeId: _requiredInt(map['cheque_id'], 'cheque_id'),
  ...
  static Map<String, Object?> toMap(ChequeAttachment attachment) {
    return <String, Object?>{
      'id': attachment.id,
      'server_uuid': attachment.serverUuid,
      'cheque_id': attachment.chequeId,
  ...
  static String kindToWireValue(ChequeAttachmentKind kind) {
    switch (kind) {
  ...
  static ChequeAttachmentKind kindFromWireValue(String value) {
    switch (value.trim().toUpperCase()) {
      case 'STATEMENT':
        return ChequeAttachmentKind.statement;

      default:
        throw ArgumentError.value(
          value,
          'value',
          'Invalid cheque attachment kind',
        );
    }
  }
