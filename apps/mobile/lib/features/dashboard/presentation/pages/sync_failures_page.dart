...
class _SyncFailuresPageState extends ConsumerState<SyncFailuresPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(title: const Text('جزئیات صف همگام‌سازی')),
        body: Column(
          children: [
                    ...
                    return RefreshIndicator(
                      ...
                      child: ListView(
                        ...
                        children: const [
                          ...
                          Center(
                            child: Text(
                              'رکوردی در این وضعیت وجود ندارد.',
                              textAlign: TextAlign.right,
                            ),
                          ),
                        ],
      ...
      child: Wrap(
        ...
        children: [
          ...
          ChoiceChip(
            ...
            onSelected: (_) => onChanged(SyncFailuresFilter.pending),
          ),
          ChoiceChip(
            label: const Text('انجام‌شده'),
            selected: selected == SyncFailuresFilter.completed,
            onSelected: (_) => onChanged(SyncFailuresFilter.completed),
          ),
        ],
      ),
    );
...
class _FailureCard extends StatelessWidget {
                ...
                Expanded(
                  child: FilledButton(
                    ...
                    child: isBusy
                        ...
                        : const Text('تلاش مجدد همین رکورد'),
                  ),
                ),
                ...
                if (item.status == 'SYNCED')
                  Expanded(
                    child: OutlinedButton(
                      ...
                      child: const Text('پاک‌کردن از تاریخچه'),
                    ),
                  ),
              ],
            ),
  ...
  String _entityTypeLabel(String raw) {
    switch (raw.trim().toUpperCase()) {
      ...
      case 'CASH_PAYMENT':
        return 'واریز نقدی';
      case 'CASH_PAYMENT_ATTACHMENT':
        return 'ضمیمه واریز نقدی';
      default:
        return raw;
    }
  }
