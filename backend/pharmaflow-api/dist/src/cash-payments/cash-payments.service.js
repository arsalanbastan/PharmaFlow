...
exports.CashPaymentsService = void 0;
...
let CashPaymentsService = class CashPaymentsService {
    prisma;
    auditLog;
    ...
    async create(createCashPaymentDto) {
        ...
        const data = {
            ...
            archivedAt: createCashPaymentDto.archivedAt == null
        ...
        if (requestedId == null) {
            return this.prisma.$transaction(async (tx) => {
                ...
                await (0, push_outbox_service_1.enqueueCashPaymentCreatedPush)(created.id, tx);
                return created;
            });
        }
        return this.prisma.$transaction(async (tx) => {
            ...
            if (previous == null) {
                await (0, push_outbox_service_1.enqueueCashPaymentCreatedPush)(result.id, tx);
            }
            return result;
        });
    }
    ...
    async update(id, updateCashPaymentDto) {
...
exports.CashPaymentsService = CashPaymentsService;
exports.CashPaymentsService = CashPaymentsService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService,
        audit_log_service_1.AuditLogService])
], CashPaymentsService);
//# sourceMappingURL=cash-payments.service.js.map