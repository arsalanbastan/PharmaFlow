...
exports.CashPaymentAttachmentsService = void 0;
...
let CashPaymentAttachmentsService = class CashPaymentAttachmentsService {
    prisma;
    auditLog;
    storage;
    constructor(prisma, auditLog, storage) {
        this.prisma = prisma;
    ...
    async prepareUpload(dto) {
        ...
        const attachmentId = dto.id?.trim() || (0, node_crypto_1.randomUUID)();
    ...
    async confirmUpload(dto) {
        ...
        return this.prisma.$transaction(async (tx) => {
            ...
            if (previous != null && previous.cashPaymentId !== dto.cashPaymentId) {
                throw new common_1.BadRequestException('Attachment UUID already belongs to another cash payment.');
            }
    ...
    async createDownloadUrl(id) {
        ...
        if (attachment == null) {
            throw new common_1.NotFoundException('Cash payment attachment not found.');
        }
        const prepared = await this.storage.createDownloadUrl(attachment.storageKey);
        return {
            attachment,
    ...
    async requireActiveCashPayment(cashPaymentId) {
...
exports.CashPaymentAttachmentsService = CashPaymentAttachmentsService;
exports.CashPaymentAttachmentsService = CashPaymentAttachmentsService = __decorate([
...
//# sourceMappingURL=cash-payment-attachments.service.js.map